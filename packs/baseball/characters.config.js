(function (c) {
  ...
  c.characters = [
    ...
    {id:"36",jersey:36,name:"天賦異稟",image:"assets/solid-bird-sidearm-36.webp?v=4",description:"先天掌握多種球路 · 球種養成較快",initialStats:{...base,luck:{min:35,max:43}},modifiers:{training:1.25,cap:108},opportunityChapter:0,startingPitches:["四縫線直球","曲球","變速球","滑球"],startingAbilities:["天賦"]},
