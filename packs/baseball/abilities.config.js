(function (c) {
  c.abilities = [
    ...
    {id:"王建民",name:"王建民",category:"pitching",hiddenUntilUnlocked:true,description:"連續投 50 顆伸卡球後覺醒；改投其他球種會重新計算。伸卡球被打進場內時，一定轉化為滾地出局。",unlock:{counter:"sinkerStreak",pitch:"伸卡球",atLeast:50},trigger:"ON_BALL_IN_PLAY"},
    {id:"大谷翔平",name:"大谷翔平",category:"pitching",hiddenUntilUnlocked:true,description:"連續投 50 顆滑球後覺醒；改投其他球種會重新計算。面對每位新打者時，第一球若選擇滑球必定是好球。",unlock:{counter:"sliderStreak",pitch:"滑球",atLeast:50},trigger:"BEFORE_PITCH_RESULT"}
  ];
})(window.V47_CONFIG);
