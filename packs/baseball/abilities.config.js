(function (c) {
  c.abilities = [
    ...
    {id:"一球入魂",name:"一球入魂",category:"pitching",hiddenUntilUnlocked:true,description:"連續投 50 顆四縫線直球後覺醒；兩好球後投四縫線必定三振。",unlock:{counter:"fourSeamStreak",pitch:"四縫線直球",atLeast:50},trigger:"BEFORE_PITCH_RESULT"},
