(function (c) {
  c.stats = [
    ...
    {id:"speed",name:"球速",visible:true,min:0,max:99,description:"影響快速球壓制、揮空與球探評價。畫面會依換算錨點顯示實際球速。",display:{kind:"piecewise",unit:"km/h",decimals:0,anchors:[{score:0,value:20},{score:50,value:70},{score:80,value:150},{score:100,value:170},{score:110,value:180}]},training:{enabled:true,baseSuccessRate:.90,difficultyAfter:[{value:50,penalty:.03},{value:70,penalty:.10},{value:90,penalty:.22}]}},
