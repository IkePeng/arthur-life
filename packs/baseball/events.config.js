...
c.annualEvents=[
  ...
  {icon:"📵",title:"代言產品爆發爭議",text:"你合作的品牌被揭露資料不實。即使你沒有參與決策，名字仍和產品綁在一起。",choices:[["解約並退回部分代言費",{money:-250,fame:-2},"你付出金錢止血，公關危機暫時停住。"],["等待調查不做回應",{fame:-5,fans:-1200,spirit:-3},"沉默讓外界自行填補故事。"],["召開記者會承認判斷失誤",{fame:-3,spirit:-4,luck:-2},"坦白沒有立刻修復形象，但避免事情繼續擴大。"]]},
